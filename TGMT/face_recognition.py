...
class FaceRecognition:
    def __init__(self, path='./'):
        # Load models
        self.faceDetectionModel = os.path.join(path, 'model/res10_300x300_ssd_iter_140000_fp16.caffemodel')
        self.faceDetectionProto = os.path.join(path, 'model/deploy.prototxt.txt')
        self.faceDescriptor = os.path.join(path, 'model/openface.nn4.small2.v1.t7')
